...
## ⏭️ ยังไม่ได้ทำ (feature ต่อยอด — ดู INTEGRATION roadmap)
- SOP step-skip (LLM อ่าน timeline เทียบ 7 steps)
- Safety-rule + severity mapping (LLM จับคู่ narration → rule)

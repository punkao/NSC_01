...
- ⚠️ **F4 SOP step-skip** (`analyze_sop.py`) — **EXPERIMENTAL ไม่ใช้** ติด data ceiling (VLM แยกกล่อง NG/WAIT/GOOD ไม่ออก) → ดู `FINDINGS_SOP.md` (เก็บเป็น finding + future work)

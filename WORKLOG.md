...
> ## 📌 หมายเหตุ (เพิ่ม 2026-07-17)
>
> ไฟล์นี้เป็น **บันทึกตามลำดับเวลา** — แต่ละ entry คือสิ่งที่ **เชื่อ ณ วันนั้น** ไม่ใช่ข้อสรุปปัจจุบัน
> โดยเฉพาะ entry ก่อน 2026-07-16 ที่ใช้คำว่า *"definitive"* / *"ผลสุดท้าย"* — **ตัวเลขเหล่านั้นถูกล้มไปแล้ว**
> เพราะเฉลยที่ใช้วัดผิด 32 จุด (ดู `MEASUREMENTS.md` §2.4 และ §2.7)
>
> **ตัวเลขปัจจุบันที่ถูกต้องมีที่เดียว: `MEASUREMENTS.md`** — อย่าอ้างตัวเลขจากไฟล์นี้
